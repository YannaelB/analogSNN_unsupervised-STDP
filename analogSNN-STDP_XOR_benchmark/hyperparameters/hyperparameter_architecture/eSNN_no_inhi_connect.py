...
class SNN_eNeuron():
    def __init__(self, debug=False):
        ...
        print("You've created :",len(model['input_synapse_exci'])+len(model['wta_synapse']) , "synapses in your network")
    ...
    def evaluation(self,idx_epoch,X_test,y_test,plot=False):
        ...
        return accuracy_max,accuracy_mean,accuracy_temporal,accuracy_2,accuracy_4, self.weight_evol_exci


directory = "hyperparams_no_inhi_backup"
def assessing_no_inhi_connect(itera):
    '''
    ...
    for idx_epoch in range(epoch_max):
        ...
        accuracy_max,accuracy_mean,accuracy_temporal,accuracy_2,accuracy_4,weight_evol_exci = model.evaluation(idx_epoch,X_test,y_test,plot=debug)

...
directory = "hyperparams_no_hidden_backup"
def assessing_no_hidden_layer(itera):
    '''
    ...
    for idx_epoch in range(epoch_max):
        ...
        if accuracy_max >= 1:
            break
    print("done assessing_classic in idx_epoch = ", idx_epoch+1, "epochs for accuracy = ", accuracy_max)

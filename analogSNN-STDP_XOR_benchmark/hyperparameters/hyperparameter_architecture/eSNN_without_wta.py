...
class SNN_eNeuron():
    def __init__(self, debug=False):
        ...
        print("You've created :",len(model['input_synapse_exci'])+len(model['input_synapse_inhi']) , "synapses in your network")
...
directory = "hyperparams_without_wta_backup"
def assessing_without_wta(itera):
    '''
